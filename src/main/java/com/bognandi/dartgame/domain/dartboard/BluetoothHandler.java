...
public class BluetoothHandler implements Closeable {
    ...
    private final Handler handler = new Handler(BluetoothHandler.class.getCanonicalName());
...
//    private static final UUID BLOOD_PRESSURE_MEASUREMENT_CHARACTERISTIC_UUID = UUID.fromString("00002A35-0000-1000-8000-00805f9b34fb");
    ...
    private static final UUID HTS_SERVICE_UUID = UUID.fromString("00001801-0000-1000-8000-00805f9b34fb");
    private static final UUID TEMPERATURE_MEASUREMENT_CHARACTERISTIC_UUID = UUID.fromString("442f1571-8a00-9a28-cbe1-e1d4212d53eb");
